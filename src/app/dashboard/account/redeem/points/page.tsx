      ...
      <div className="lg:w-5/12 w-12/12 mx-auto pb-10 lg:mt-10 mt-20">
        ...
        <div className="relative flex justify-center items-center gap-8 my-10">
          <button
            ...
            className={`relative flex justify-center items-center h-20 w-20 rounded-full ${
        ...
        <form className="mt-9">
          <div>
            <label
              htmlFor="points"
              className="block text-sm font-medium text-[#323232] mb-8">
              Enter Phone Number
            </label>
            <input
              type="number"
              className="w-full text-sm font-medium text-black placeholder:text-[#000000a6] outline-none border-b border-solid border-[#D9D9D9] pb-2"
