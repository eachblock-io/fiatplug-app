    ...
    <div className="h-screen fixed top-0 bottom-0 left-0 right-0 z-20 bg-white">
      <div className="w-10/12 mx-auto mt-20">
        ...
        <div className="text-center mt-10">
          <p className="text-[#6B4201]">Points redeemed</p>
          ...
          <div className="shadow-xl rounded-xl border mt-10 text-center">
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="great text-center p-8 cursor-pointer">
                <Image
                  ...
                  className="mx-auto"
                />
                <p className="font-bold mt-3 text-[#007AFF] text-lg">Great!</p>
              </div>
            </div>
          </div>
